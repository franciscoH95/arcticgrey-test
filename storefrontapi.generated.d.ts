...
export type FooterQueryVariables = StorefrontAPI.Exact<{
  country?: StorefrontAPI.InputMaybe<StorefrontAPI.CountryCode>;
  aboutUsMenuHandle: StorefrontAPI.Scalars['String']['input'];
  supportMenuHandle: StorefrontAPI.Scalars['String']['input'];
  importantLinkMenuHandle: StorefrontAPI.Scalars['String']['input'];
  legalMenuHandle: StorefrontAPI.Scalars['String']['input'];
  language?: StorefrontAPI.InputMaybe<StorefrontAPI.LanguageCode>;
}>;

export type FooterQuery = {
  aboutUsMenu?: StorefrontAPI.Maybe<
    Pick<StorefrontAPI.Menu, 'id' | 'title'> & {
      items: Array<
        Pick<
          StorefrontAPI.MenuItem,
  ...
  >;
  importantLinkMenu?: StorefrontAPI.Maybe<
    Pick<StorefrontAPI.Menu, 'id' | 'title'> & {
      items: Array<
        Pick<
          StorefrontAPI.MenuItem,
...
> & {
  images: {edges: Array<{node: Pick<StorefrontAPI.Image, 'url' | 'altText'>}>};
...
export type CollectionsWithProductsQueryQueryVariables = StorefrontAPI.Exact<{
  firstCollection: StorefrontAPI.Scalars['Int']['input'];
}>;

export type CollectionsWithProductsQueryQuery = {
  collections: {
    edges: Array<{
...
interface GeneratedQueryTypes {
  ...
  '#graphql\n  query Footer(\n    $country: CountryCode\n    $aboutUsMenuHandle: String!\n    $supportMenuHandle: String!\n    $importantLinkMenuHandle: String!\n    $legalMenuHandle: String!\n    $language: LanguageCode\n  ) @inContext(language: $language, country: $country) {\n    aboutUsMenu: menu(handle: $aboutUsMenuHandle) {\n      ...Menu\n    },\n    supportMenu: menu(handle: $supportMenuHandle) {\n      ...Menu\n    }\n    importantLinkMenu: menu(handle: $importantLinkMenuHandle) {\n      ...Menu\n    }\n    legalMenu: menu(handle: $legalMenuHandle) {\n      ...Menu\n    }\n  }\n  #graphql\n  fragment MenuItem on MenuItem {\n    id\n    resourceId\n    tags\n    title\n    type\n    url\n  }\n  fragment ChildMenuItem on MenuItem {\n    ...MenuItem\n  }\n  fragment ParentMenuItem on MenuItem {\n    ...MenuItem\n    items {\n      ...ChildMenuItem\n    }\n  }\n  fragment Menu on Menu {\n    id\n    title\n    items {\n      ...ParentMenuItem\n    }\n  }\n\n': {
    return: FooterQuery;
    variables: FooterQueryVariables;
  };
  '#graphql\n  query CollectionsWithProductsQuery($firstCollection: Int!) {\n    collections(first: $firstCollection) {\n      edges {\n        node {\n          ...CollectionDetails\n        }\n      }\n    }\n  }\n  #graphql\n  fragment CollectionDetails on Collection {\n    id\n    title\n    handle\n    image {\n      id\n      url\n      altText\n    }\n    products(first: 5) {\n      edges {\n        node {\n          ...ProductDetails\n        }\n      }\n    }\n  }\n  #graphql\n  fragment Product on Product {\n    id\n    title\n    vendor\n    handle\n    descriptionHtml\n    description\n    options {\n      name\n      optionValues {\n        name\n      }\n    }\n    selectedVariant: variantBySelectedOptions(selectedOptions: $selectedOptions, ignoreUnknownOptions: true, caseInsensitiveMatch: true) {\n      ...ProductVariant\n    }\n    variants(first: 1) {\n      nodes {\n        ...ProductVariant\n      }\n    }\n    seo {\n      description\n      title\n    }\n  }\n  #graphql\n  fragment ProductVariant on ProductVariant {\n    availableForSale\n    compareAtPrice {\n      amount\n      currencyCode\n    }\n    id\n    image {\n      __typename\n      id\n      url\n      altText\n      width\n      height\n    }\n    price {\n      amount\n      currencyCode\n    }\n    product {\n      title\n      handle\n    }\n    selectedOptions {\n      name\n      value\n    }\n    sku\n    title\n    unitPrice {\n      amount\n      currencyCode\n    }\n  }\n\n\n\n': {
    return: CollectionsWithProductsQueryQuery;
    variables: CollectionsWithProductsQueryQueryVariables;
  };
